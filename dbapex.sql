...
DROP PACKAGE BODY "SAMPLE_DATA_PKG";
DROP PACKAGE BODY "SAMPLE_PKG";
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "DEMO_ORDER_ITEMS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 149 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "APPLICATIONS" 
   (	"APP_ID" NUMBER(4,0), 
	"VAC_ID" NUMBER(4,0), 
	"POSITIONS" VARCHAR2(30 BYTE), 
	"APP_DATE" DATE, 
	"STATUS" VARCHAR2(20 BYTE), 
	"APPLICANT_NAME" VARCHAR2(20 BYTE), 
	"APPLICANT_ADDR" VARCHAR2(20 BYTE), 
	"APPLICANT_PHONE" NUMBER(13,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_4614308342373048" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "VACANCY" 
   (	"VAC_ID" NUMBER(4,0), 
	"VACANCY_NUM" NUMBER(4,0), 
	"VAC_POSITION" VARCHAR2(30 BYTE), 
	"LAST_DATE" DATE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
SET DEFINE OFF;
Insert into APPLICATIONS (APP_ID,VAC_ID,POSITIONS,APP_DATE,STATUS,APPLICANT_NAME,APPLICANT_ADDR,APPLICANT_PHONE) values (2,202,'IT',to_date('02-FEB-18','DD-MON-RR'),'Review','HASAN','RANG',93883);
Insert into APPLICATIONS (APP_ID,VAC_ID,POSITIONS,APP_DATE,STATUS,APPLICANT_NAME,APPLICANT_ADDR,APPLICANT_PHONE) values (3,201,'DRIVER',to_date('20-JAN-19','DD-MON-RR'),'Hire','Mithu','SYLHET',299282);
Insert into APPLICATIONS (APP_ID,VAC_ID,POSITIONS,APP_DATE,STATUS,APPLICANT_NAME,APPLICANT_ADDR,APPLICANT_PHONE) values (5,206,'Business Executive ',to_date('17-OCT-19','DD-MON-RR'),'Active','Mehedi ','Rangpur',923983);
Insert into APPLICATIONS (APP_ID,VAC_ID,POSITIONS,APP_DATE,STATUS,APPLICANT_NAME,APPLICANT_ADDR,APPLICANT_PHONE) values (1,201,'DRIVER',to_date('20-JAN-19','DD-MON-RR'),'Active','MEHEDI','DHAKA',99883);
Insert into APPLICATIONS (APP_ID,VAC_ID,POSITIONS,APP_DATE,STATUS,APPLICANT_NAME,APPLICANT_ADDR,APPLICANT_PHONE) values (4,204,'IT',to_date('30-AUG-17','DD-MON-RR'),'Hire','NAYAN','DHAKA',928827);
REM INSERTING into AWARDS
SET DEFINE OFF;
Insert into AWARDS (AWRD_ID,EMP_ID,AWARD_NAME,AMOUNT,EMPLOYEE,AWRD_DATE) values (1,101,'Gift',20000,'MEHEDI',to_date('20-JAN-19','DD-MON-RR'));
Insert into AWARDS (AWRD_ID,EMP_ID,AWARD_NAME,AMOUNT,EMPLOYEE,AWRD_DATE) values (2,103,'Car',2000,'Mehedi',to_date('11-OCT-19','DD-MON-RR'));
REM INSERTING into DEPARTMENT
SET DEFINE OFF;
Insert into DEPARTMENT (DEPT_ID,EMP_ID,DEPT_ADDR,DEPT_NAME) values (10,101,'RANGPUR','IT');
Insert into DEPARTMENT (DEPT_ID,EMP_ID,DEPT_ADDR,DEPT_NAME) values (11,103,'Dhaka, Bangladesh','Business');
Insert into DEPARTMENT (DEPT_ID,EMP_ID,DEPT_ADDR,DEPT_NAME) values (12,105,'Sylhet, Bangladesh','Freelancing');
Insert into DEPARTMENT (DEPT_ID,EMP_ID,DEPT_ADDR,DEPT_NAME) values (13,106,'Dhaka, Bangladesh','Software');
REM INSERTING into EMPLOYEE
SET DEFINE OFF;
Insert into EMPLOYEE (EMP_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,SALARY,EMP_ADDR,COUNTRY_ID,DEPT_ID,DEPARTMENT) values (106,'Fahim','Ahmed','Fahim@gmail.com',9933,23000,'Rangpur ',1005,13,'Marketing');
Insert into EMPLOYEE (EMP_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,SALARY,EMP_ADDR,COUNTRY_ID,DEPT_ID,DEPARTMENT) values (206,'Habib','Hasan','habib@gmail.com',299288292,34000,'Rangpur ',12,13,'Software');
Insert into EMPLOYEE (EMP_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,SALARY,EMP_ADDR,COUNTRY_ID,DEPT_ID,DEPARTMENT) values (101,'MEHEDI','HASAN','mehedi@gmail.com',29928,23000,'RANGPUR',1001,10,'IT');
Insert into EMPLOYEE (EMP_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,SALARY,EMP_ADDR,COUNTRY_ID,DEPT_ID,DEPARTMENT) values (103,'Nayan','Khan','nayan@gmail.com',998822,20000,'Dhaka,Bangladesh',null,11,'Business');
Insert into EMPLOYEE (EMP_ID,FIRST_NAME,LAST_NAME,EMAIL,PHONE_NUMBER,SALARY,EMP_ADDR,COUNTRY_ID,DEPT_ID,DEPARTMENT) values (105,'Rahat','Ahmed','rahat@gmail.com',928883,29000,'Rangpur',null,12,'Freelancing');
REM INSERTING into EMP_DETAILS
SET DEFINE OFF;
Insert into EMP_DETAILS (COUNTRY_ID,POSTAL_CODE,CITY,COUNTRY_NAME,REGION_NAME,EMP_ID) values (20,5403,'Rangpur','Bangladesh','Bangladesh',101);
Insert into EMP_DETAILS (COUNTRY_ID,POSTAL_CODE,CITY,COUNTRY_NAME,REGION_NAME,EMP_ID) values (1003,837,'Dhaka','Bangladesh','Bangladesh',103);
Insert into EMP_DETAILS (COUNTRY_ID,POSTAL_CODE,CITY,COUNTRY_NAME,REGION_NAME,EMP_ID) values (1001,2345,'RANGPUR','BANGLADESH','ASIA',null);
Insert into EMP_DETAILS (COUNTRY_ID,POSTAL_CODE,CITY,COUNTRY_NAME,REGION_NAME,EMP_ID) values (1004,9033,'Rangpur','Bangladesh','Bangladesh',105);
REM INSERTING into JOB_HISTORY
SET DEFINE OFF;
Insert into JOB_HISTORY (EMP_ID,DEPT_ID,START_DATE,END_DATE) values (101,10,to_date('20-JAN-17','DD-MON-RR'),to_date('25-SEP-19','DD-MON-RR'));
Insert into JOB_HISTORY (EMP_ID,DEPT_ID,START_DATE,END_DATE) values (103,11,to_date('03-OCT-19','DD-MON-RR'),null);
Insert into JOB_HISTORY (EMP_ID,DEPT_ID,START_DATE,END_DATE) values (105,12,to_date('19-OCT-19','DD-MON-RR'),null);
Insert into JOB_HISTORY (EMP_ID,DEPT_ID,START_DATE,END_DATE) values (206,13,to_date('29-OCT-19','DD-MON-RR'),null);
REM INSERTING into NOTICE
SET DEFINE OFF;
Insert into NOTICE (NOTICE_ID,NOTICE_TITLE,DESCRIPTION,NOTICE_DATE,DEPT_ID) values (2,'Notice For Awards','Dear Employeers 
I am pleased to know you that , we are given for running year performance of our employeers for their good performance . Our company is growing up rapidly . So we take decision for',to_date('10-OCT-19','DD-MON-RR'),11);
Insert into NOTICE (NOTICE_ID,NOTICE_TITLE,DESCRIPTION,NOTICE_DATE,DEPT_ID) values (5001,'Vacation','Vacation about 30 days',to_date('25-SEP-19','DD-MON-RR'),10);
REM INSERTING into VACANCY
SET DEFINE OFF;
Insert into VACANCY (VAC_ID,VACANCY_NUM,VAC_POSITION,LAST_DATE) values (203,1,'MARKETING',to_date('02-SEP-18','DD-MON-RR'));
Insert into VACANCY (VAC_ID,VACANCY_NUM,VAC_POSITION,LAST_DATE) values (204,2,'Business',to_date('08-DEC-18','DD-MON-RR'));
Insert into VACANCY (VAC_ID,VACANCY_NUM,VAC_POSITION,LAST_DATE) values (206,4,'Business Executive ',to_date('16-OCT-19','DD-MON-RR'));
Insert into VACANCY (VAC_ID,VACANCY_NUM,VAC_POSITION,LAST_DATE) values (201,3,'DRIVER',to_date('02-FEB-19','DD-MON-RR'));
Insert into VACANCY (VAC_ID,VACANCY_NUM,VAC_POSITION,LAST_DATE) values (202,4,'IT',to_date('30-OCT-19','DD-MON-RR'));
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_4614308342373048"  ENABLE;
--------------------------------------------------------
--  Constraints for Table EMP_DETAILS
--------------------------------------------------------

  ALTER TABLE "EMP_DETAILS" ADD PRIMARY KEY ("COUNTRY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_4614308342373048"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "AWARDS" ADD PRIMARY KEY ("AWRD_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_4614308342373048"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "APPLICATIONS" ADD PRIMARY KEY ("APP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_4614308342373048"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "VACANCY" ADD PRIMARY KEY ("VAC_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_4614308342373048"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "APPLICATIONS" ADD CONSTRAINT "APP_VAC_FK" FOREIGN KEY ("VAC_ID")
	  REFERENCES "VACANCY" ("VAC_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table AWARDS
--------------------------------------------------------

  ALTER TABLE "AWARDS" ADD CONSTRAINT "AWRD_EMP_FK" FOREIGN KEY ("EMP_ID")
	  REFERENCES "EMPLOYEE" ("EMP_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMPLOYEE
--------------------------------------------------------

  ALTER TABLE "EMPLOYEE" ADD CONSTRAINT "EMP_ID_FK" FOREIGN KEY ("DEPT_ID")
	  REFERENCES "DEPARTMENT" ("DEPT_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMP_DETAILS
--------------------------------------------------------

  ALTER TABLE "EMP_DETAILS" ADD CONSTRAINT "DETAIL_EMP_ID" FOREIGN KEY ("EMP_ID")
	  REFERENCES "EMPLOYEE" ("EMP_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table JOB_HISTORY
--------------------------------------------------------

  ALTER TABLE "JOB_HISTORY" ADD CONSTRAINT "JOB_DEPT_FK" FOREIGN KEY ("DEPT_ID")
	  REFERENCES "DEPARTMENT" ("DEPT_ID") ENABLE;
  ALTER TABLE "JOB_HISTORY" ADD CONSTRAINT "JOB_EMP_FK" FOREIGN KEY ("EMP_ID")
	  REFERENCES "EMPLOYEE" ("EMP_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table NOTICE
--------------------------------------------------------

  ALTER TABLE "NOTICE" ADD CONSTRAINT "NOT_DEPT_FK" FOREIGN KEY ("DEPT_ID")
	  REFERENCES "DEPARTMENT" ("DEPT_ID") ENABLE;
--------------------------------------------------------
